...
# import shelve # binary option to store data

# shelf_file = shelve.open('data')
# words = ['was', 'das', 'you']
# shelf_file['words'] = words
# shelf_file.close()
...
# Saving variables with print.pformat()

# import pprint # way to save something in .py file

# fruits = [{'name' : 'Apple', 'colour' : 'red'}, {'name' : 'Orange', 'colour' : 'orange'}, {'name' : 'Banana', 'colour' : 'yellow'}]
# pprint.pformat(fruits)
# file_fruits = open('fruits.py', 'w')
# file_fruits.write('fruits = ' + pprint.pformat(fruits) + '\n')
# file_fruits.close()

# import fruits # import savet .py file
# fruits.fruits
# fruits.fruits[0]